...
//	}
	...
	/**
	 * Evaluate {@code expr} and return {@code true} if it succeeded, {@code false}
	 * otherwise. On success, {@code bindings} will have {@code expr.getArity()}
	 * more elements than before, and the input stream's position may have
	 * increased. On failure, {@code bindings} and position will be unchanged.
	 * 
	 * @param expr
	 * @return
	 */
