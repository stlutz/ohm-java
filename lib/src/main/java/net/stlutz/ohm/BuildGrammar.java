...
public class BuildGrammar extends Semantics {
  private Build buildOperation;

  public Build getBuildOperation() {
  ...
  public List<Grammar> buildGrammars(Node node, Namespace namespace) {
    var builder = new GrammarBuilder(namespace);
  ...
  public Grammar buildGrammar(Node node) {
  ...
  public PExpr buildPExpr(Node node) {
    return buildOperation.build(node);
  }
  ...
  public static class Build extends Operation {
    ...
    public void setBuilder(GrammarBuilder builder) {
      this.builder = builder;
    }

    public GrammarDefinition getCurrentGrammar() {
      return currentGrammar;
    }

    public void setCurrentGrammar(GrammarDefinition currentGrammar) {
      this.currentGrammar = currentGrammar;
    }

    public RuleDefinition getCurrentRule() {
      return currentRule;
    }

    public void setCurrentRule(RuleDefinition currentRule) {
