...
public class ArithmeticSemantics extends Semantics {
  private Interpret interpretOperation;

  @Override
  public void initialize() {
    interpretOperation = Interpret.class.cast(getOperation("interpret"));
  }

  public double interpret(Node node) {
    return interpretOperation.interpret(node);
  }

  @Named("interpret")
  public class Interpret extends Operation {
