...
public class TestNot extends AbstractPExprTest {
    ...
    protected void registerBasicEvalTestCases() {
        addBasicEvalTestCase("Hello Hello", 0, not(terminal("Hello")), -1);
        addBasicEvalTestCase("Hello Hello", 1, not(terminal("Hello")), 0);
        addBasicEvalTestCase("Hello Hello", 6, not(terminal("Hello")), -1);
        addBasicEvalTestCase("Hell o", 0, not(terminal("Hello")), 0);
    }
}
