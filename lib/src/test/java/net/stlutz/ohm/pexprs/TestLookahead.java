...
public class TestLookahead extends AbstractPExprTest {
    ...
    protected void registerBasicEvalTestCases() {
        addBasicEvalTestCase("Hello Hello", 0, lookahead(terminal("Hello")), 0);
        addBasicEvalTestCase("Hello Hello", 1, lookahead(terminal("Hello")), -1);
        addBasicEvalTestCase("Hello Hello", 6, lookahead(terminal("Hello")), 0);
        addBasicEvalTestCase("Hell o", 0, lookahead(terminal("Hello")), -1);
    }
}
