...
class LineAndColumnInfoTest {
	...
	void testMiddleLine() {
		...
		assertEquals("Ullamcorper malesuada proin libero nunc consequat interdum varius sit amet.", info.previousLine);
	...
	void testFirstLine() {
		...
		assertEquals("Ullamcorper malesuada proin libero nunc consequat interdum varius sit amet.", info.nextLine);
	}
